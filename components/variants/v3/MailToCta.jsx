      ...
      <div className="section-frame">
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-2 xl:grid-cols-3 xl:gap-5">
          {features.map((feature) => {
            ...
            return (
              <article key={feature.title} className="soft-card rounded-[28px] p-6 xl:p-5">
                <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-slate-100 text-slate-900">
                  <Icon className="h-5 w-5" />
                </div>
                <h3 className="mt-5 text-[1.02rem] font-semibold tracking-[-0.03em] text-slate-950 xl:text-[1.08rem]">
                  {feature.title}
                </h3>
        ...
        <div className="mt-12 text-center">
          <h3 className="display-heading text-[1.65rem] font-semibold text-slate-950 sm:text-[1.85rem] xl:text-[1.95rem]">
            Ready to try it out?
          </h3>

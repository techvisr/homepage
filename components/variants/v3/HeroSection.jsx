...
const metrics = [
  {
    layoutClass: "figma-hero-metric--launches",
    desktopClass:
  ...
  {
    layoutClass: "figma-hero-metric--reliability",
    desktopClass:
  ...
  {
    layoutClass: "figma-hero-metric--velocity",
    desktopClass:
      "right-[4%] top-[128px] w-[174px] rotate-[-5deg] sm:right-[16%] sm:top-[136px] sm:w-[200px] md:left-auto md:right-[18%] md:top-[104px] md:w-[250px] lg:right-[24%] lg:top-[104px] lg:w-[220px] xl:right-[19%] xl:w-[300px] 2xl:w-[360px] min-[1800px]:w-[400px]",
  ...
  {
    layoutClass: "figma-hero-metric--efficiency",
    desktopClass:
...
export default function HeroSection() {
  return (
    <section className="figma-hero relative max-w-[100vw] overflow-hidden bg-black text-white">
      <video
      ...
      <div
        className="figma-hero-metrics pointer-events-none absolute inset-x-0 top-[286px] z-30 mx-auto hidden h-[235px] w-full max-w-[900px] select-none lg:block xl:top-[318px] xl:h-[280px] xl:max-w-[1100px] 2xl:top-[360px] 2xl:h-[310px] 2xl:max-w-[1180px] min-[1800px]:top-[390px] min-[1800px]:h-[340px] min-[1800px]:max-w-[1320px]"
        aria-label="Business outcome metrics"
      >
        {metrics.map((metric, index) => (
          <div
            className={`figma-hero-metric pointer-events-none absolute select-none ${metric.layoutClass} ${metric.desktopClass} ${metric.motionClass}`}
            key={metric.alt}
      ...
      <div className="figma-hero-content relative z-40 grid min-h-[clamp(400px,52svh,480px)] content-start px-4 pb-4 pt-6 min-[360px]:px-5 sm:px-8 sm:pt-10 md:min-h-[clamp(500px,62svh,600px)] md:pb-6 md:pt-12 lg:min-h-[clamp(540px,72svh,620px)] lg:px-12 lg:pt-14 xl:min-h-[clamp(620px,70svh,700px)] xl:px-16 xl:pt-16 2xl:min-h-[clamp(700px,70svh,780px)] 2xl:px-24 2xl:pt-20 min-[1800px]:min-h-[clamp(760px,82svh,860px)] min-[1800px]:pt-24">
        <div className="figma-hero-header mx-auto grid w-full min-w-0 max-w-[1040px] justify-items-center gap-3 text-center sm:gap-5 md:gap-6 lg:gap-6">
          <div className="figma-hero-copy">
            <div className="figma-hero-title-frame">
              <h1 className="figma-hero-title m-0 max-w-full text-[1.62rem] font-extrabold leading-[1.04] tracking-[0] [font-family:var(--font-figma-display),Barlow,sans-serif] [text-shadow:0_8px_32px_rgba(0,0,0,0.38)] motion-safe:animate-[heroReveal_800ms_ease_both] min-[360px]:text-[1.78rem] sm:text-[2.45rem] md:text-[3.1rem] lg:max-w-[900px] lg:text-[3.35rem] lg:leading-[1] xl:text-[4rem] 2xl:text-[4.6rem]">
                AI-Native Engineering for Modern Digital Enterprises
              </h1>
            </div>
            <div className="figma-hero-body-frame">
              <p className="figma-hero-body m-0 max-w-[38rem] text-xs leading-[1.42] [text-shadow:0_5px_22px_rgba(0,0,0,0.42)] motion-safe:animate-[heroReveal_800ms_120ms_ease_both] min-[360px]:text-[13px] sm:text-[15px] md:max-w-[46rem] md:text-base lg:max-w-[52rem] lg:text-base lg:leading-[1.32] xl:text-lg 2xl:text-xl">
          ...
          <HeaderActionButton
            light
            className="figma-hero-cta max-w-full rounded-xl !min-h-11 !px-5 !py-3 text-sm font-semibold motion-safe:animate-[heroReveal_800ms_220ms_ease_both] sm:text-base xl:rounded-[14px]"
          >

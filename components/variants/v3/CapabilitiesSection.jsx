...
export default function CapabilitiesSection({ asset, capabilities }) {
  return (
    <section
      id="services"
      className="relative isolate grid justify-items-center overflow-hidden bg-[radial-gradient(80%_48%_at_50%_0%,rgba(243,113,53,0.1),transparent_60%),linear-gradient(180deg,#ffffff_0%,#fff9f6_52%,#ffffff_100%)] px-5 py-14 md:px-8 md:py-[72px] lg:px-20 lg:py-[96px]"
    >
      <div
      ...
      <div className="relative z-10 mx-auto mb-10 grid max-w-[960px] gap-4 text-center md:mb-12 lg:mb-[58px]">
        <h2 className="m-0 text-[34px] font-extrabold leading-[1.1] tracking-[0] text-[#161821] md:text-[48px] lg:text-[62px]">
          Our Strategic Capabilities
        </h2>
        <p className="mx-auto m-0 max-w-[850px] text-[16px] leading-[1.42] text-[rgba(22,24,33,0.68)] md:text-[20px] md:leading-[1.34] lg:text-[24px]">
          Scale faster with AI-powered capabilities that improve efficiency, agility, and enterprise-wide decision-making.
        </p>
      </div>

      <div className="relative z-10 mb-9 grid w-full max-w-[1080px] grid-cols-1 gap-5 md:mb-11 md:grid-cols-2 md:gap-7 lg:mb-12 lg:gap-8">
        {capabilities.map((capability) => (
          <article
            className="reveal-card group relative isolate h-[258px] overflow-hidden rounded-[16px] bg-white shadow-[0_14px_32px_rgba(22,24,33,0.1)] md:h-[286px] lg:h-[302px]"
          ...
          >
            ...
            <div className="absolute inset-x-0 bottom-0 z-10 grid gap-2 px-6 pb-5 text-left md:px-7 md:pb-6 lg:px-9 lg:pb-7">
              <h3 className="m-0 text-[18px] font-extrabold uppercase leading-[1.14] tracking-[0] text-[#161821] md:text-[20px] lg:text-[22px]">
                {capability.title}
              </h3>
              <p className="m-0 max-w-[450px] text-[14px] font-semibold leading-[1.34] text-[#07080c] md:text-[15px] lg:text-[16px]">
                {capability.text}
              </p>
            </div>
          </article>
